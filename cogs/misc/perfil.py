...
class Perfil(commands.Cog):
    ...
    async def perfil(self, interaction: discord.Interaction, membro: discord.Member = None):
        ...
        # criação da embed
        prof = discord.Embed(title='Esté o meu perfil.',
                            description='Seja livre pra ver um pouco mais sobre minha história aqui:', colour=discord.Colour.random())  # Usa cor random
